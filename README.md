...
- **OpenRouter + Llama 3.1 70B** — fast, reliable inference via the OpenRouter API with a model capable of nuanced conversation and reliable classification
...
Returns `200 OK` when OpenRouter and Supabase are reachable, `503` if either is down.
...
| `LLM_MODEL` | | `meta-llama/llama-3.1-70b-instruct` | OpenRouter model identifier |
